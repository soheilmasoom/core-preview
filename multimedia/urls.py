...
from multimedia.views import ImageCreateView, BannerListView, SectionsView, ArticleView, ArticleSearchView, \
    PinnedArticlesView, FileCreateView, LatestBlogPostsView, FAQCategoryViewSet, FAQByCategoryView
...
urlpatterns = [
    ...
    path('faq-categories/', FAQCategoryViewSet.as_view({
        'get': 'list',
    })),
    path('faq-categories/<int:category_id>/', FAQByCategoryView.as_view()),
