...
TICKER_REDIS = config('TICKER_REDIS', default='redis://127.0.0.1:6379/2')
...
MINIO_PUBLIC_MEDIA_FILES_BUCKET = config('MINIO_PUBLIC_MEDIA_FILES_BUCKET', default='core-media-public')
MINIO_MEDIA_FILES_BUCKET = config('MINIO_MEDIA_FILES_BUCKET', default='core-media')
MINIO_STATIC_FILES_BUCKET = config('MINIO_STATIC_FILES_BUCKET', default='core-static')
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        ...
        'basic_verify': '5/minute',
        'basic_verify_daily': '20/day',
    },
