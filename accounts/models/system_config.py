...
class SystemConfig(models.Model):
    ...
    commission_type = models.CharField(
        ...
        help_text=(
            ...
            "'FEE_DEDUCT_RECEIVING' deducts the fee from the receiving amount (Raastin Behaviour), "
            "while 'FEE_ADD_PAYING' adds the fee to the paying amount (Milli Gold Behaviour)."
        )
    )
